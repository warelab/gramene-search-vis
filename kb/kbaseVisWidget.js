...
module.exports = KBWidget({
  ...
  appendUI: function ($elem) {
    ...
    //XXX FUCK! D3svg is pointing to a reference to the parent's D3svg, but that might not yet exist. Which means that
    // I need to rewire fucking everything to use a goddamn method instead. Fuck my life.
      ...
      function (idx, region) {
        ...
        D3svg.selectAll('.' + region).selectAll('g').data([{
          ...
          .attr('transform', function (d) {
            ...
            var transform = $vis.options.transformations[d.r] || $vis.options.transformations.global;//{ translate : {x
